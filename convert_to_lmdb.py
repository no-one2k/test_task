...
def create_lmdb_meta_file(num_train_examples,
#num_val_examples,
...
def main(args):
    ...
    [num_train_examples
    #, num_val_examples
    ] = convert_to_lmdb([(path_to_train_dir, path_to_train_digit_struct_mat_file),
    ...
    create_lmdb_meta_file(num_train_examples,
    #num_val_examples,
    num_test_examples, path_to_lmdb_meta_file)
